...
admin-smite-homing-rod-slow-name = Замедленный следующий стержень
...
admin-smite-remove-hand-description = Лишает цель одной из рук.
...
admin-smite-homing-rod-description = Запускает неподвижный стержень который будет лететь за целью.
admin-smite-homing-rod-slow-description = Запускает замедленный неподвижный стержень который будет лететь за целью.
admin-smite-silicon-laws-bound-description = Даёт цели список законов синтетиков, а так же заменяет роль игрока на синтетика.
