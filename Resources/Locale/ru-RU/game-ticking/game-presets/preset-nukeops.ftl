...
nukeops-welcome =
    Вы — ядерный оперативник. Ваша задача — взорвать { $station } и убедиться, что от неё осталась лишь груда обломков. Ваше руководство, Синдиката, снабдило вас всем необходимым для выполнения этой задачи.
    Операция "{ $name }" началась! Смерть Пакту!
