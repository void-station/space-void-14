...
bounty-description-artifact = Пакт находится в затруднительном положении из-за кражи артефактов с планет, не практикующих космические полёты. Верните один, и мы выплатим за него компенсацию.
...
bounty-description-knife = Один из наших лучших командиров недавно выиграл совершенно новый набор ножей на официальном игровом шоу Пакта. К сожалению, у нас нет такого набора под рукой. Пришлите нам кучу острых предметов, чтобы мы могли что-нибудь придумать.
...
bounty-description-pancake = В Пакте мы считаем сотрудников семьёй. А вы знаете, что любят семьи? Блины. Отправьте дюжину.
...
bounty-description-soup = Чтобы подавить восстание бездомных, Пакт будет угощать супом всех малооплачиваемых работников. Отправьте любой вид супа.
...
bounty-description-syringe = Группе Пакта по борьбе с наркотиками нужны шприцы, чтобы распространять их среди малообеспеченных слоёв населения. Помогите некоторым людям сохранить работу.
